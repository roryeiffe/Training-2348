...
### Creating and Typing Context

* What problem does the Context API solve, and when should it *not* be used?
* How do you properly type a React context value in TypeScript?
* Why is `undefined` often used as the default value for `createContext`, and how do you handle it safely?

### Using `useContext` with Types

* How does TypeScript infer types when using `useContext`?
* What happens if you consume a context outside its provider, and how can you guard against it?
...
### Typing Inputs and Return Values

* How do you type the return value of a custom hook that returns multiple values?
* When would you return an object vs a tuple from a custom hook?

### Building Reusable Hooks

* What makes a hook “reusable” versus just extracted logic?
* What rules must all custom hooks follow?

## Form Handling & Validation

### Schema Validation

* What is schema validation, and why is it useful in forms?
* How does schema validation differ from manual field validation?

### Custom Validation Messages

* How do you define field-specific error messages in a schema?

### Submitting Forms

* How does React Hook Form handle submission differently from native forms?
* What happens if validation fails during submission?
* How should loading and error states be handled during form submission?
* Where should side effects like navigation or API calls live after submission?
